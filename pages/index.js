...
import useAuth from "../pages/hook/useContext";
...
const Dashboard = () => {
    ...
    const {order,affilateUser,user,review} = useAuth()
        ...
        <div className="grid">
                ...
                <div className="card mb-0 cursor-pointer">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            ...
                            <div className="text-900 font-medium text-xl">{order.total}</div>
                        </div>
            ...
            <Link href="/affiliates">
                <div className="card mb-0 cursor-pointer">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Affiliate</span>
                            <div className="text-900 font-medium text-xl">{affilateUser.length}</div>
                        </div>
                ...
                <div className="card mb-0 cursor-pointer">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            ...
                            <div className="text-900 font-medium text-xl">{user.length}</div>
                        </div>
                ...
                <div className="card mb-0 cursor-pointer">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            ...
                            <div className="text-900 font-medium text-xl">{review.length} UnApprove</div>
                        </div>
            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    <div className='flex justify-content-center justify-content-between'><h5>Recent Reviews</h5>
                    <Link href="/reviews">View All</Link></div>
                    <DataTable value={review} rows={5} paginator>
