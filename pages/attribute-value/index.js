...
import { index, destroy } from '../../service/api/attribute-value';
    ...
    const attributeValueTemplate = (rowData) => {
        ...
        return (
            <React.Fragment>
                ...
                <a href={'/attribute-value/'+rowData._id}>Configure Attribute Values</a>
            </React.Fragment>
        );
    };
    useEffect(() => {
...
List.getInitialProps = async () => {
    ...
    return { pageTitle:{url:'/attribute',name:"Attribute Value Page"} };
};
