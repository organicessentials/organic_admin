...
export function show(id) {
    return instance
        .get(`/auth/show/attributeValue/${id}`)
        .then((response) => response.data)
...
export function create(categoryData) {
    return instance
        .post('/auth/create/attributeValue', categoryData)
        .then((response) => response.data)
...
export function update(id, categoryData) {
    return instance
        .put(`/auth/update/attributeValue/${id}`, categoryData)
        .then((response) => response.data)
...
export function destroy(id) {
    return instance
        .delete(`/auth/delete/attributeValue/${id}`)
        .then((response) => response.data)
...
export function indexValue(id) {
    return instance
        .get(`/auth/show/attributeValue/val/${id}`)
...
export function createValue(data) {
    return instance
        .post(`/auth/create/attributeValue/val/${data.id}`,{name:data.name})
        .then((response) => response.data)
...
export function updateValue(data) {
    console.log(data);
    return instance
        .post(`/auth/update/attributeValue/val/${data.id}`,data)
        .then((response) => response.data)
...
export function destroyValue({id,valId}) {
    ...
    return instance
        .delete(`auth/delete/attributeValue/val/${id}`,{data:{valId}})
        .then((response) => response.data)
